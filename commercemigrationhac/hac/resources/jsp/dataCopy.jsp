...
<div class="prepend-top span-24" id="content">
    <div id="migrationPanel" class="marginLeft colborder span-17">
        ...
        <div class="prepend-top clearfix status">
            <div id="copyStatus" class="span-8" data-url="<c:url value="/commercemigrationhac/copyStatus"/>">
                <dl>
                    <dt>ID</dt>
        ...
        <div class="prepend-top">
            <form id="formCopyReport" method="GET" action="<c:url value="/commercemigrationhac/copyReport"/>">
    ...
    <div id="metricsPanel" class="span-5">
        <div id="charts" class="marginLeft" data-chartDataUrl="<c:url value="/commercemigrationhac/metrics"/>" />
    </div>
</div>
</body>
</html>
