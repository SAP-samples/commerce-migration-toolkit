            ...
            <div class="prepend-top span-17 colborder" id="content">
                ...
                <div class="marginLeft marginBottom">
                    ...
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            <button id="buttonMigrateSchemaPreview" data-url="<c:url value="/commercemigrationhac/previewSchemaMigration"/>">Preview Schema Migration Changes</button>
                        ...
                        <div id="tabs-2">
                            ...
                            <form:form method="post" action="${url}" modelAttribute="schemaSqlForm">
                                <div class="prepend-top">
                                    ...
                                    <button id="buttonGenerateSchemaScript" data-url="<c:url value="/commercemigrationhac/generateSchemaScript"/>">Generate Schema Script</button>
                                ...
                                <div class="prepend-top">
                                    ...
                                    <button <c:if test="${schemaMigrationDisabled}">disabled</c:if> id="buttonMigrateSchema" data-url="<c:url value="/commercemigrationhac/migrateSchema"/>">Execute script</button>
                                </div>
                            </form:form>
                        </div>
                    </div>
